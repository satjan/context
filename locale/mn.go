...
// for all built in tag's in _validator; you may add your own as desired.
func RegisterDefaultTranslations(v *validator.Validate, trans ut.Translator) (err error) {
	translations := []struct {
		...
		{
			tag:         "required",
			translation: "{0} хоосон байна",
			override:    false,
		},
		{
			tag:         "upwd",
			translation: "Нууц үг нь 1 том үсэг, 1 жижиг үсэг, тоо агуулсан байна (Зөвхөн англи үсэг болон тоо оруулна уу)\n",
			override:    false,
		},
		{
			tag: "len",
		...
		},
		{
			tag: "min",
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("min-string", "{0} нь хамгийн багадаа {1} урттай байна", false); err != nil {
					return
				}

				if err = ut.AddCardinal("min-string-character", "{0} тэмдэгтийн", locales.PluralRuleOne, false); err != nil {
					return
				}

				if err = ut.AddCardinal("min-string-character", "{0} тэмдэгтийн", locales.PluralRuleOther, false); err != nil {
					return
				}
		...
		},
		{
			tag: "max",
			customRegisFunc: func(ut ut.Translator) (err error) {
				if err = ut.Add("max-string", "{0} нь хамгийн ихдээ {1} урттай байна", false); err != nil {
					return
				}

				if err = ut.AddCardinal("max-string-character", "{0} тэмдэгтийн", locales.PluralRuleOne, false); err != nil {
					return
				}

				if err = ut.AddCardinal("max-string-character", "{0} тэмдэгтийн", locales.PluralRuleOther, false); err != nil {
					return
				}
		...
		{
			tag:         "eqfield",
			translation: "{0} нь {1}-тай ижил утгатай байх ёстой",
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), fe.Field(), fe.Param())
				if err != nil {
		...
		{
			tag:         "number",
			translation: "{0} тоон утга оруулна уу",
			override:    false,
		},
		{
			tag:         "hexadecimal",
		...
		{
			tag:         "email",
			translation: "Имэйл хаяг буруу",
			override:    false,
		},
		{
			tag:         "url",
			translation: "{0} URL буруу байна",
			override:    false,
		},
		{
			tag:         "uri",
